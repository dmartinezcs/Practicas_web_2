...
### Pasos previos
Comprobar tener node y npm instalados, ademas de axios, next y vite<br/>
npm install, npm install axios, npm install next y node -v npm -v (en el terminal a la altura de {en mi caso}Practicas_web_1) para ver que estan instaladas las dependencias.
